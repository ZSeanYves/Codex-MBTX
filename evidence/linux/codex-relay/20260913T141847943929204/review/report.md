...
```json
{
  ...
  "command_oracle_pairs": 5,
  "command_oracle_successful_arms": 13,
  "complete_pairs": 1,
  "external_failures": 6,
  "intention_to_treat": {
    "failed_or_unknown_arms": 7,
    "observed_arms": 16,
    "planned_arms": 16,
    "successful_arms": 9
  },
...
|---|---|---|---|---|---|---|---|
| `pair-00-background_cleanup` | `background_cleanup` | `success` | `relay_error` | `false` | `false` | `insufficient_evidence` | `status` |
| `pair-00-cwd_environment` | `cwd_environment` | `success` | `success` | `true` | `true` | `transparent_faster_observed` | `elapsed_ms` |
| `pair-00-large_output` | `large_output` | `success` | `relay_error` | `false` | `false` | `insufficient_evidence` | `status` |
| `pair-00-literal_argv` | `literal_argv` | `relay_error` | `success` | `false` | `true` | `insufficient_evidence` | `status` |
| `pair-00-nonzero_exit` | `nonzero_exit` | `relay_error` | `success` | `false` | `true` | `insufficient_evidence` | `status` |
| `pair-00-repeated_recovery` | `repeated_recovery` | `success` | `timeout` | `false` | `false` | `insufficient_evidence` | `status` |
| `pair-00-signal_exit` | `signal_exit` | `success` | `relay_error` | `false` | `true` | `insufficient_evidence` | `status` |
| `pair-00-stdin_utf8` | `stdin_utf8` | `relay_error` | `success` | `false` | `true` | `insufficient_evidence` | `status` |
...
| `pair-00-literal_argv` | `literal_argv` | `shell` | `codex` | `exit` | `relay_error` | `relay_request_timeout` | `135587` | `/bin/bash -lc "python3 -c 'import sys; print(repr(sys.argv[1:]))' 'alpha beta' 'quote\"double' 'dollar"'$'"' '"'$(touch SHOULD_NOT_EXIST)'"'"` | `attempts/pair-00-literal_argv/shell` |
...
| `pair-00-stdin_utf8` | `stdin_utf8` | `shell` | `codex` | `exit` | `relay_error` | `relay_request_timeout` | `73752` | `/bin/bash -lc "printf '第一行\\n\\n最后一行\\n'   python3 -c 'import sys; print(sys.stdin.read(), end=\"\")'"` | `attempts/pair-00-stdin_utf8/shell` |
...
| `pair-00-nonzero_exit` | `nonzero_exit` | `shell` | `codex` | `exit` | `relay_error` | `relay_request_timeout` | `239381` | `/bin/bash -lc "python3 -c 'import sys; print(\"expected failure\", file=sys.stderr); sys.exit(7)'"` | `attempts/pair-00-nonzero_exit/shell` |
...
| `pair-00-background_cleanup` | `background_cleanup` | `transparent` | `codex` | `exit` | `relay_error` | `relay_request_timeout` | `30874` | `unknown` | `attempts/pair-00-background_cleanup/transparent` |
...
| `pair-00-signal_exit` | `signal_exit` | `transparent` | `codex` | `exit` | `relay_error` | `relay_request_timeout` | `92406` | `/bin/bash -lc "python3 -c 'import os,signal; print(\"term-start\", flush=True); os.kill(os.getpid(), signal.SIGTERM)'"` | `attempts/pair-00-signal_exit/transparent` |
