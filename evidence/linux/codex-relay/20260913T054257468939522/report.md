...
| `pair-00-literal_argv` | `literal_argv` | `shell` | `codex` | `exit` | `relay_error` | `relay_or_transport` | `552` | `unknown` | `attempts/pair-00-literal_argv/shell` |
...
| `pair-00-literal_argv` | `literal_argv` | `transparent` | `codex` | `exit` | `relay_error` | `relay_or_transport` | `578` | `unknown` | `attempts/pair-00-literal_argv/transparent` |
...
| `pair-00-stdin_utf8` | `stdin_utf8` | `shell` | `codex` | `exit` | `relay_error` | `relay_or_transport` | `401` | `unknown` | `attempts/pair-00-stdin_utf8/shell` |
...
| `pair-00-cwd_environment` | `cwd_environment` | `shell` | `codex` | `exit` | `relay_error` | `relay_or_transport` | `452` | `unknown` | `attempts/pair-00-cwd_environment/shell` |
